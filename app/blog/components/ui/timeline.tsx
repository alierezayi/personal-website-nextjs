...
function TimelineItem({ item }: { item: TimelineEntry }) {
  ...
  return (
    <div className="flex justify-start pt-10 md:pt-20 md:gap-10">
      <div className="sticky flex flex-col md:flex-row z-20 items-center top-40 self-start md:max-w-[250px] lg:max-w-sm md:w-full">
      ...
      <div className="relative pl-20 pr-4 md:pl-4 w-full">
        <div>
          ...
          <div className="flex flex-col md:flex-row justify-between gap-y-1 mb-5">
            <div className="flex items-center gap-1">
              <Calendar variant="Linear" className="size-3.5" />
              <span className="text-xs">{renderDate(item.date)}</span>
            </div>
            {item.location ? (
              <div className="flex items-center gap-1">
                <Location variant="Linear" className="size-3.5" />
